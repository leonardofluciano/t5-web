...
class SubsidiariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create subsidiary" do
    assert_difference('Subsidiary.count') do
      post subsidiaries_url, params: { subsidiary: { document: @subsidiary.document, legal_name: @subsidiary.legal_name, name: @subsidiary.name } }
    end
  ...
  test "should update subsidiary" do
    patch subsidiary_url(@subsidiary), params: { subsidiary: { document: @subsidiary.document, legal_name: @subsidiary.legal_name, name: @subsidiary.name } }
